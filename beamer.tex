...
\begin{document}
    ...
    \input{src/contents/beamer/b-hermiticity.tex}
    \input{src/contents/beamer/b-pt-operators.tex}
    \input{src/contents/beamer/b-pt-symmetric-qm.tex}
    \input{src/contents/beamer/b-examples.tex}
