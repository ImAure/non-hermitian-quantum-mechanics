\chapter{Parity Inversion and Time Reversal Operators}\label{ch:pt-operators}
    ...
    \section{\PT\ Symmetry}
        ...
        \begin{equation}
            ...
            \myperiod
        \end{equation}
        We say that an operator \hA\ is \emph{\PT-invariant} or \emph{\PT-Symmetric} if $\PTtransform{\hA} = \hA$. The condition of \PT-invariance can be expressed in a cleaner way via a little manipulation:
        \begin{equation*}
            \PTtransform{\hA} = \hA
            \quad\iff\quad
            \hPT\hA = \hA\hPT
