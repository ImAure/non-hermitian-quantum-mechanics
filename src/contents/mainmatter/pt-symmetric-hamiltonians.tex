    ...
    \section{Orthogonality under the \texorpdfstring{\PT}{PT} inner product}\label{s:orthogonality}
        ...
        \subsection{An attempt at the \PT\ inner product}
            ...
            \begin{equation}
                ...
                \mycomma
            \end{equation}
            where $\Omega\subseteq\bbR^3$ is a region of space where \PT\ Symmetry is unbroken,\footnote{For a more detailed explanation see \apref{a:stokes}.} and the action of the \PT\ conjugation on $\phi$ is given by
            \begin{equation*}
