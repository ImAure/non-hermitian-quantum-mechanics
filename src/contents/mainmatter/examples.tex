\chapter{Examples and Applications}\label{ch:examples}
    ...
    In this chapter we will explore the $2\times2$ matrix Hamiltonian presented in \Sref{s:problem} further and look at a more concrete system obtained from a non-Hermitian deformation of the Hamiltonian of the Quantum Harmonic Oscillator.
