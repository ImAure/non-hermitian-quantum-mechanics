\chapter{Examples and Applications}\label{ch:examples}
    ...
    In this chapter we will explore further the $2\times2$ matrix Hamiltonian presented in \Sref{s:problem} and look at a more concrete system obtained from a non-Hermitian deformation of the Hamiltonian of the Quantum Harmonic Oscillator.
    \section{A finite dimensional Hamiltonian}
        ...
        \begin{equation}
            ...
            \mycomma
        \end{equation}
        where the \PT\ outer product $\dyad{\cdot}{\cdot}_{\PT}$ is again evaluated in terms of the standard outer product as 
        \begin{equation*}
        ...
        Finally, we evaluate the similarity transformation that yields the Hermitian isospectral Hamiltonian \hF. We recall from \eqref{eq:C-exponential} that
        \begin{equation*}
            \myexp{\hQ} = \hC\hP
            \myperiod
        \end{equation*}
        ...
        \section{Deformation of the Harmonic Oscillator}\label{s:deformed-harmonic-oscillator}
            ...
            A remarkable case is obtained when $\varepsilon = 2$, which yields the Hamiltonian
            \begin{equation}
                \hH = \hp^2 - \hx^4
                \myperiod
            \end{equation}
